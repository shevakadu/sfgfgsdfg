...
const connection = mysql.createConnection({
    host: "db4free.net",
    user: "sasasa69420",
    password: "sasasa69420",
    database: "sasasa69420"
})
...
console.log("===[i] Enabling real-time console requests...")
const readline = require('readline');
const insertrequestui = readline.createInterface({
    input: process.stdin,
...
process.stdin.on('keypress', (str, key) => {
    ...
    if (key.ctrl && key.name === 'l') {
        logAllowed = false
        insertrequestui.question("===[?] Insert a request into the server runtime below\n\t[ ", function(response) {
            process.stdout.write(" ]\n")
            console.log(response)
            insertrequestui.close()
            logAllowed = true
        })
    }
  });

  console.log("===[v] Real-time console requests have been enabled!")